...
class Category(models.Model):
    ...
    description = models.TextField(blank=True, verbose_name="Category Description", null=True)
...
class Product(models.Model):
    ...
    short_description = models.TextField(verbose_name="Short Description", null=True)
    ...
    category = models.ForeignKey(Category, verbose_name="Product Category", on_delete=models.CASCADE, default=1)
    is_active = models.BooleanField(verbose_name="Is Active?", default=True)
    is_featured = models.BooleanField(verbose_name="Is Featured?", default=True)
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Created Date")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated Date")
